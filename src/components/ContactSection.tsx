...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative z-10 py-24 px-6" ref={ref}>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16" data-animate>
          <p className="font-accent text-gold text-sm tracking-[0.3em] uppercase mb-3">Reach Out</p>
          <h2 className="font-display text-3xl md:text-4xl gradient-gold-text">Contact Us</h2>
          <div className="w-16 h-px gradient-gold mx-auto mt-4" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div data-animate className="flex flex-col items-center text-center p-6 rounded-lg gold-border-glow bg-card/50">
            <Phone className="w-8 h-8 text-gold mb-4" />
            <h3 className="font-display text-sm text-foreground mb-2 tracking-wider">Phone</h3>
          ...
          <div data-animate className="flex flex-col items-center text-center p-6 rounded-lg gold-border-glow bg-card/50">
            ...
            <h3 className="font-display text-sm text-foreground mb-2 tracking-wider">Email</h3>
          ...
          <div data-animate className="flex flex-col items-center text-center p-6 rounded-lg gold-border-glow bg-card/50">
            ...
            <h3 className="font-display text-sm text-foreground mb-2 tracking-wider">Address</h3>
